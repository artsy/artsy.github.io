...
The app passed reivdw, and we had the app retina ready before the hardware release, and we pulled the app within a few minutes of testing it on a real retina iPad. This post will explain why, and what we did to make it smooth.
