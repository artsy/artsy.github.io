...
title: Artsy's Engineering Culture, 2017
date: 2017-04-19
...
<!--conways law, but for culture? -->
<!-- Remote -->
<!-- Diversity & Inclusion -->
<!-- OSS vs Closed source projects?  -->
<!-- is closed source 2nd class? -->
<!-- Are people who work on closed source, negatively effected? Careers hampered? Isac with hokusai-->
<!-- How teams differentiate -->
<!-- How practices difference -->
<!-- How decisions get made? -->
<!-- General meetings for everyone (note geekbot)-->
<!-- Diaries, github repos for teams (waffle/zenhub) -->
<!-- General sense of convergence -->
<!--note alloys slackbot -->
<!-- Standups etc? -->
<!-- L&L, blog workshop, workshops non-techs -->
<!-- Expansion of L&L -->
