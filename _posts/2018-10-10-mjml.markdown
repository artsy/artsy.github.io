...
`<mj-head>` as a kind of global stylesheet and the `body --> section --> column` flow. But once we got comfortable
with them, it became hard to imagine what life was like before MJML.
